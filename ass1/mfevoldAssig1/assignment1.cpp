...
//To run: ./assignment1 /filepath #_of_threads
//where /filepath is the path to file
//and #_of_threads is the number of threads to spawn. It can be any number of threads.
...
//this function isn't used but was used during development.
...
int main(int argc, char **argv)
{
	...
	char *filepath;
	//arg1: filepath, arg2: number threads
        if(argc<3)
        {
	...
	//without being computationally complex, alternatively I could have created a struct and done pretty much the same thing.
	...
	for(int r = 0; r < thread_number; r++){
		...
		int i = r;
		//create the thread... passing the index of the thread
	...
	//output. *If I use 1 vs 1.0 it doesn't default to a double variable which is kind of annoying
...
void *thread_action(void *i)
{
	...
	//get starting point for next thread(which would be your stopping point
